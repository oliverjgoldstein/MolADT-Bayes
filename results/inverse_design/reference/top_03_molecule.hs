...
molecule = either error id (validateMolecule (Molecule
  ...
  , systems =
      ...
      , (SystemId 10, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 2) (AtomId 10)]) Nothing)
      , (SystemId 11, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 1) (AtomId 11)]) Nothing)
      , (SystemId 12, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 2) (AtomId 12)]) Nothing)
      , (SystemId 13, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 7) (AtomId 13)]) Nothing)
      , (SystemId 14, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 9) (AtomId 14)]) Nothing)
      , (SystemId 15, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 9) (AtomId 15)]) Nothing)
      , (SystemId 16, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 9) (AtomId 16)]) Nothing)
      ]
