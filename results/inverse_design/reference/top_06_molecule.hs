...
molecule = either error id (validateMolecule (Molecule
  ...
  , systems =
      ...
      , (SystemId 6, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 6) (AtomId 7)]) Nothing)
      ...
      , (SystemId 10, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 3) (AtomId 11)]) Nothing)
      , (SystemId 11, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 5) (AtomId 12)]) Nothing)
      , (SystemId 12, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 5) (AtomId 13)]) Nothing)
      ]
