...
molecule = either error id (validateMolecule (Molecule
  ...
  , systems =
      ...
      , (SystemId 8, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 4) (AtomId 9)]) Nothing)
      , (SystemId 9, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 4) (AtomId 10)]) Nothing)
      , (SystemId 10, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 5) (AtomId 11)]) Nothing)
      , (SystemId 11, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 6) (AtomId 12)]) Nothing)
      , (SystemId 12, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 6) (AtomId 13)]) Nothing)
      , (SystemId 13, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 6) (AtomId 14)]) Nothing)
      ]
