...
molecule = either error id (validateMolecule (Molecule
  ...
  , systems =
      ...
      , (SystemId 6, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 3) (AtomId 7)]) Nothing)
      , (SystemId 7, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 4) (AtomId 8)]) Nothing)
      , (SystemId 8, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 1) (AtomId 9)]) Nothing)
      , (SystemId 9, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 1) (AtomId 10)]) Nothing)
      , (SystemId 10, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 2) (AtomId 11)]) Nothing)
      , (SystemId 11, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 2) (AtomId 12)]) Nothing)
      , (SystemId 12, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 7) (AtomId 13)]) Nothing)
      , (SystemId 13, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 9) (AtomId 14)]) Nothing)
      , (SystemId 14, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 9) (AtomId 15)]) Nothing)
      , (SystemId 15, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 9) (AtomId 16)]) Nothing)
      , (SystemId 16, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 10) (AtomId 17)]) Nothing)
      , (SystemId 17, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 10) (AtomId 18)]) Nothing)
      , (SystemId 18, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 10) (AtomId 19)]) Nothing)
      ]
