...
molecule = either error id (validateMolecule (Molecule
  ...
  , systems =
      ...
      , (SystemId 7, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 1) (AtomId 8)]) Nothing)
      ...
      , (SystemId 11, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 4) (AtomId 12)]) Nothing)
      , (SystemId 12, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 4) (AtomId 13)]) Nothing)
      , (SystemId 13, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 7) (AtomId 14)]) Nothing)
      ]
