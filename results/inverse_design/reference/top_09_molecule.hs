...
molecule = either error id (validateMolecule (Molecule
  ...
  , systems =
      ...
      , (SystemId 3, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 3) (AtomId 4)]) Nothing)
      , (SystemId 4, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 2) (AtomId 5)]) Nothing)
      , (SystemId 5, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 5) (AtomId 6)]) Nothing)
      , (SystemId 6, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 5) (AtomId 7)]) Nothing)
      , (SystemId 7, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 7) (AtomId 8)]) Nothing)
      , (SystemId 8, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 3) (AtomId 9)]) Nothing)
      , (SystemId 9, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 2) (AtomId 10)]) Nothing)
      , (SystemId 10, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 4) (AtomId 11)]) Nothing)
      , (SystemId 11, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 3) (AtomId 12)]) Nothing)
      , (SystemId 12, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 4) (AtomId 13)]) Nothing)
      , (SystemId 13, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 4) (AtomId 14)]) Nothing)
      , (SystemId 14, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 5) (AtomId 15)]) Nothing)
      , (SystemId 15, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 6) (AtomId 16)]) Nothing)
      , (SystemId 16, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 6) (AtomId 17)]) Nothing)
      , (SystemId 17, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 6) (AtomId 18)]) Nothing)
      , (SystemId 18, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 7) (AtomId 19)]) Nothing)
      , (SystemId 19, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 8) (AtomId 20)]) Nothing)
      , (SystemId 20, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 8) (AtomId 21)]) Nothing)
      , (SystemId 21, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 8) (AtomId 22)]) Nothing)
      , (SystemId 22, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 10) (AtomId 23)]) Nothing)
      , (SystemId 23, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 10) (AtomId 24)]) Nothing)
      , (SystemId 24, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 10) (AtomId 25)]) Nothing)
      ]
