...
benzene = Molecule
  ...
  , systems =
      ...
      , (SystemId 3, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 1) (AtomId 6))) Nothing)
      , (SystemId 4, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 1) (AtomId 7))) Nothing)
      ...
      , (SystemId 8, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 3) (AtomId 9))) Nothing)
      , (SystemId 9, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 4) (AtomId 5))) Nothing)
      , (SystemId 10, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 4) (AtomId 10))) Nothing)
      , (SystemId 11, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 5) (AtomId 6))) Nothing)
      , (SystemId 12, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 5) (AtomId 11))) Nothing)
      , (SystemId 13, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 6) (AtomId 12))) Nothing)
      ]
