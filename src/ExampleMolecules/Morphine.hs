...
morphinePretty = Molecule
  ...
  , systems =
      [ (SystemId 1, mkBondingSystem (NonNegative 6) (S.fromList [Edge (AtomId 10) (AtomId 11), Edge (AtomId 10) (AtomId 16), Edge (AtomId 11) (AtomId 12), Edge (AtomId 12) (AtomId 14), Edge (AtomId 14) (AtomId 15), Edge (AtomId 15) (AtomId 16)]) (Just "phenyl_pi_ring"))
      ]
        ++ [ (SystemId 2, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 1) (AtomId 2))) Nothing)
           , (SystemId 3, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 1) (AtomId 11))) Nothing)
           ...
           , (SystemId 7, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 3) (AtomId 5))) Nothing)
           , (SystemId 8, mkBondingSystem (NonNegative 4) (S.singleton (Edge (AtomId 5) (AtomId 6))) Nothing)
           , (SystemId 9, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 6) (AtomId 7))) Nothing)
           , (SystemId 10, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 7) (AtomId 8))) Nothing)
           , (SystemId 11, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 7) (AtomId 18))) Nothing)
           , (SystemId 12, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 8) (AtomId 9))) Nothing)
           , (SystemId 13, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 8) (AtomId 10))) Nothing)
           , (SystemId 14, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 9) (AtomId 21))) Nothing)
           , (SystemId 15, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 10) (AtomId 11))) Nothing)
           , (SystemId 16, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 10) (AtomId 16))) Nothing)
           , (SystemId 17, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 11) (AtomId 12))) Nothing)
           , (SystemId 18, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 12) (AtomId 13))) Nothing)
           , (SystemId 19, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 12) (AtomId 14))) Nothing)
           , (SystemId 20, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 14) (AtomId 15))) Nothing)
           , (SystemId 21, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 15) (AtomId 16))) Nothing)
           , (SystemId 22, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 16) (AtomId 17))) Nothing)
           , (SystemId 23, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 17) (AtomId 18))) Nothing)
           , (SystemId 24, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 18) (AtomId 19))) Nothing)
           , (SystemId 25, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 19) (AtomId 20))) Nothing)
           , (SystemId 26, mkBondingSystem (NonNegative 2) (S.singleton (Edge (AtomId 19) (AtomId 21))) Nothing)
           ]
